<form id="fifContactForm" class="fif-contact-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
	...
	<div class="form-group">
		<input type="text" class="form-control fif-form-control" placeholder="Your Name" id="name" name="name">
		<small class="text-danger form-control-msg">Your Name is Required</small>
	</div>

	<div class="form-group">
		<input type="email" class="form-control fif-form-control" placeholder="Your Email" id="email" name="email">
