<?php
/**
 * Fortnight In Florida engine room
 *
 * @package storefront
*/

/*--------------------------------------------------------------
Function Inclued Files
--------------------------------------------------------------*/
...
require ( get_stylesheet_directory() . '/inc/tagcloudwidget.php' );
require ( get_stylesheet_directory() . '/inc/nav-breakpoint-custom.php' );
