<form id="fifSignUpForm" class="fif-signup-form" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
	...
	<div class="form-button">
		...
		<small class="text-success form-control-msg js-mailing-form-success">Your details have been successfully submitted, thank you!</small>
