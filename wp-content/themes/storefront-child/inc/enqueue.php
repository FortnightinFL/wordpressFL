...
function fif_load_scripts(){
 ...
 elseif (is_page( 'signup') ) {
   ...
   // In-flight page CSS
   wp_enqueue_style( 'signupcss', get_stylesheet_directory_uri() . '/signup/signupcss/signup-style.css', array() );

   // In-flight page JS
   wp_enqueue_script( 'signupjs', get_stylesheet_directory_uri() . '/signup/signupjs/signup.js', array( 'jquery' ) );
